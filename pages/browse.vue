<template>
  <main v-if="baseAikus && aikusForFeed && aikuImgMap.size > 0">
    ...
    <div class="fixed bottom-0 px-4 pb-6 flex items-center justify-between w-full" :style="'opacity:' + opacity + ';'">
      ...
      <NuxtLink to="/" class="flex items-center space-x-3 border border-zinc-500 py-1 px-2 rounded-lg text-zinc-300 bg-black/60 hover:text-zinc-100 hover:bg-black hover:border-zinc-200 transition-hover-300" style="text-shadow: 1px 1px 8px black;">
