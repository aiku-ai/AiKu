          ...
          <div>
            <div>
              ...
              <div class="mt-1 grid grid-cols-3 gap-3">
                ...
                <div>
                  <button @click="login('github')" type="button" class="inline-flex w-full justify-center rounded-md border border-zinc-300 bg-white py-2 px-4 text-sm font-medium text-zinc-500 shadow-sm hover:bg-zinc-50">
