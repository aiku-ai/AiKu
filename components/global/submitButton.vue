<template>
  <div class="flex items-center">
    ...
    <button v-if="props.isValidState && !props.submitLoading" @click="$emit('submit')" type="button"
      ...
      class="w-full inline-flex items-center justify-center border border-transparent font-bold rounded shadow-sm focus:outline-none focus:ring-1 focus:ring-offset-1 transition-hover-300">
      <div v-if="props.svg" class="mr-3" v-html="props.svg"></div>
      {{ props.submitText }}
    </button>
    ...
    <button v-if="props.submitLoading" type="button" :class="[colorClassesDisabled, bttnSize]"
      class="w-full inline-flex items-center justify-center justify-center border border-transparent font-bold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-default"
      disabled>
